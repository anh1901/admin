          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/documentation/react/build/alert"
                  target="_blank"
                >
                  <svg
                    width="20"
          ...
          <Tab.Container defaultActiveKey="first">
              ...
              <Nav as="ul" className=" nav-tabs nav-tunnel nav-slider">
                <Nav.Item className="" role="presentation">
                  <Nav.Link
                    ...
                    onClick={() => toggleTab(1)}
                    data-bs-toggle="tab"
                    data-bs-target="#content-accordion-prv"
                    type="button"
                    role="tab"
                ...
                <Nav.Item as="li" role="presentation">
                  <Nav.Link
                    ...
                    onClick={() => toggleTab(2)}
                    data-bs-toggle="tab"
                    data-bs-target="#content-accordion-code"
                    type="button"
                    role="tab"
            ...
            <Tab.Content className="">
              <Tab.Pane
                ...
                id="content-accordion-prv"
                role="tabpanel"
                aria-labelledby="typo-output"
              >
                <div className="bd-example">
                  <Alert
                    variant="primary alert-solid  alert-dismissible fade show"
                    show={showA1}
                    role="alert"
                ...
                <div className="bd-example">
                  <Alert
                    variant="primary alert-dismissible fade show"
                    role="alert"
                    show={showA2}
                ...
                <div className="bd-example">
                  ...
                  <Alert
                    variant="info lert-top alert-dismissible fade show mb-3"
                    role="alert"
                    show={showA4}
                  ...
                  <Alert
                    variant="warning right alert-dismissible fade show mb-3"
                    role="alert"
                    show={showA5}
                  ...
                  <Alert
                    variant="danger bottom alert-dismissible fade show"
                    role="alert"
                    show={showA6}
                ...
                <div className="bd-example">
                  ...
                  <Alert
                    variant="warning alert-solid rounded-0 alert-dismissible fade show "
                    role="alert"
                    show={showA8}
