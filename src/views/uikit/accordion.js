...
import { Accordion, Nav, Tab, Button } from "react-bootstrap";
          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/documentation/react/build/accordion"
                  target="_blank"
                >
                  <svg
                    width="20"
        ...
        <Card className="iq-document-card iq-doc-head">
          <Tab.Container defaultActiveKey="first">
            ...
            <Tab.Content>
              <Tab.Pane
                eventKey="first"
                className={toggleState === true ? "active" : ""}
                  ...
                  <Accordion defaultActiveKey="0">
                    ...
                    <Accordion.Item eventKey="1">
                      ...
                      <Accordion.Body>
                        ...
                        about any HTML can go within the .accordion-body, though
              ...
              <Tab.Pane
                eventKey="second"
                className={toggleState === false ? "active" : ""}
