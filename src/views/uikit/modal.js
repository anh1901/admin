...
const Modals = () => {
  ...
  function handleShow4(breakpoint) {
  ...
  return (
          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/documentation/react/build/modal"
                  target="_blank"
                >
                  <svg
                    width="20"
              ...
              <Nav as="ul" className="nav-tabs nav-tunnel nav-slider">
                <Nav.Item as="li" role="presentation">
                  <Nav.Link
                    ...
                    data-bs-toggle="tab"
                    data-bs-target="#content-Modal-prv"
                    type="button"
                    role="tab"
                ...
                <Nav.Item as="li" role="presentation">
                  <Nav.Link
                    ...
                    data-bs-toggle="tab"
                    data-bs-target="#content-Modal-code"
                    type="button"
                    role="tab"
              ...
              >
                <div className="bd-example">
                  <div className="d-flex justify-content-between flex-wrap">
                    ...
                    <Button variant="primary mt-2" onClick={handleShow3}>
                    ...
                    <Modal scrollable={true} show={show3} onHide={handleClose3}>
                      <Modal.Header closeButton>
                        <Modal.Title as="h5">Modal title</Modal.Title>
                      </Modal.Header>
                      <Modal.Body style={{ color: "black" }}>
                        <p>
                          ...
                          demonstrate how content can exceed minimum inner
                          height, thereby showing inner scrolling. When content
                          becomes longer than the prefedined max-height of
                          modal, content will be cropped and scrollable within
                          the modal.
                        </p>
                        <br />
                        <br />
    ...
    <div className="d-flex justify-content-between flex-wrap">
        ...
        <Modal scrollable={true} show={show3} onHide={handleClose3}>
            ...
            {values.map((v, idx) => (
            <Button key={idx} className="me-2" onClick={() => handleShow4(v)}>
                Full screen
                {typeof v === 'string' && below ${"v.split('-')[0]"}}
            </Button>
        ))}
