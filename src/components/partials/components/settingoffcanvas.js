...
const SettingOffcanvas = (props) => {
  ...
  const sidebartypeActives = (type) => {
    if (type === "sidebar-mini") {
      if (
        props.sidebarTypeMode.mini === null ||
        props.sidebarTypeMode.mini === ""
      ) {
    ...
    if (type === "sidebar-hover") {
      if (
        props.sidebarTypeMode.hover === null ||
        props.sidebarTypeMode.hover === ""
      ) {
    ...
    if (type === "sidebar-boxed") {
      if (
        props.sidebarTypeMode.boxed === null ||
        props.sidebarTypeMode.boxed === ""
      ) {
  ...
  useEffect(() => {
    ...
    if (sidebarboxtypeMode === "sidebar-boxed") {
      ...
      document
        .querySelector(".sidebar-default")
        .classList.remove("sidebar-boxed");
    ...
    if (sidebarhovertypeMode === "sidebar-hover") {
      ...
      document
        .querySelector(".sidebar-default")
        .classList.remove("sidebar-hover");
          ...
          <Row>
            <Col lg={12}>
              ...
              <div className="grid-cols-3 mb-4 d-grid gap-x-3">
                <div className="text-center">
                  <img
                    ...
                    alt="mini"
                    onClick={() => {
                      sidebartypeActives("sidebar-mini");
                    }}
                    className="p-0 mode dark-img img-fluid btn-border flex-column"
                    data-setting="sidebar"
                  ...
                  <img
                    ...
                    className="p-0 mode light-img img-fluid btn-border flex-column"
                    data-setting="sidebar"
                    data-name="sidebar-type"
                    data-value="sidebar-mini"
                  />
                ...
                <div className="text-center">
                  <img
                    ...
                    alt="hover"
                    onClick={() => {
                      sidebartypeActives("sidebar-hover");
                    }}
                    className="p-0 mode dark-img img-fluid btn-border flex-column"
                    data-setting="sidebar"
                    data-name="sidebar-type"
                ...
                <div className="text-center">
                  <img
                    ...
                    alt="boxed"
                    onClick={() => {
                      sidebartypeActives("sidebar-boxed");
                    }}
                    className="p-0 mode dark-img img-fluid btn-border flex-column"
                    data-setting="sidebar"
                    data-name="sidebar-type"
              ...
              <div className="grid-cols-2 d-grid gap-x-3">
                ...
                <div
                  className="btn btn-border active col-span-full"
                  data-setting="navbar"
